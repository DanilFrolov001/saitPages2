...
function myFunction010() {
  var dots010 = document.getElementById("dots010");
  var moreText = document.getElementById("more010");
  var btnText = document.getElementById("myBtn010");


  if (dots010.style.display === "none" ) {
    dots010.style.display = "inline";
    btnText.innerHTML = "More detalis";
    moreText.style.display = "none";
    
  } else {
    dots010.style.display = "none";
    btnText.innerHTML = "More detalis";
    moreText.style.display = "inline";
  }
